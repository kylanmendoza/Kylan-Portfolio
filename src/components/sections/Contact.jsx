                ...
                <form className="space-y-6">
                    <div className="relative">
                        <input 
                            ...
                            id="name" 
                            name="name" 
                            className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5"required
                            placeholder="Name..."
                        />
                    </div>
